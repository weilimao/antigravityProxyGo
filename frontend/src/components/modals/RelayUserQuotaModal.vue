<template>
<div class="hidden fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center modal-backdrop-animate" id="relayUserQuotaModal">
<div class="bg-white dark:bg-[#1e2538] rounded-xl shadow-2xl w-[480px] p-6 border border-outline-variant/20 modal-content-animate">
...
<button class="text-outline hover:text-on-surface transition-colors" onclick="window._relayCloseModal('relayUserQuotaModal')">
...
<button class="px-4 py-2 text-[12px] font-medium text-outline hover:text-on-surface border border-outline-variant/30 rounded-lg transition-colors" onclick="window._relayCloseModal('relayUserQuotaModal')" data-i18n="btnCancel">取消</button>
</div>
</div>
</div>
</template>
