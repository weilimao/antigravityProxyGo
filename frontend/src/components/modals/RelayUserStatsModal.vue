<template>
<div class="hidden fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center" id="relayUserStatsModal">
<div class="bg-white dark:bg-[#1e2538] rounded-xl shadow-2xl w-[90%] max-w-[700px] p-6 border border-outline-variant/20">
...
<div class="space-y-4 max-h-[60vh] overflow-y-auto" id="relayUserStatsContent">
